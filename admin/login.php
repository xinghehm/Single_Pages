...
<form method="post"><input type="text" name="username" placeholder="管理员用户名" required class="w-full px-4 py-3 rounded-lg mb-3"><input type="password" name="password" placeholder="密码" required class="w-full px-4 py-3 rounded-lg mb-4"><button type="submit" class="btn-primary w-full py-3">登录</button></form></div></body></html>