...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <div class="glass-card max-w-5xl mx-auto p-6">
        ...
        <form method="post">
            <textarea name="content" rows="20" class="w-full p-4 font-mono text-sm bg-white border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"><?= htmlspecialchars($content) ?></textarea>
