    ...
    <div class="glass-card max-w-5xl mx-auto p-6">
        ...
        <form method="post">
            <textarea name="content" rows="20"
                class="w-full p-4 font-mono text-sm bg-white/50 border border-gray-200 rounded-lg focus:outline-none focus:border-blue-500"><?= htmlspecialchars($content) ?></textarea>
