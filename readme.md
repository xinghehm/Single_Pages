...
**演示站**：net.xhhe.cn  
**GitHub**：github.com/xinghehm/Single_Pages

## 更新日志

### v2.4.0（2026-09-22）
- 新增极验行为验证码（v3.0/v4.0 双版本兼容，后台可配置版本和密钥）
- 新增登录失败次数限制与登录日志（用户端/后台均可查看）
- 新增项目访问统计（近14天 Chart.js 图表展示）
- 新增项目模板系统（6个内置模板，新建项目时可选）
- 新增项目克隆功能
- 新增后台系统信息面板（PHP/MySQL/磁盘/扩展/数据库备份/过期清理）
- 新增暗黑模式切换
- 新增在线升级系统（全自动文件+数据库升级，支持版本检查、一键升级、备份管理）
- UI 全面重写，全局白底简洁风格，去除 AI 味
- 修复 open_basedir 限制导致的升级备份路径问题
- 修复侧边栏布局依赖 Tailwind CDN 导致的横版问题
- install 目录更新为 v2.4 完整结构（12表+新配置项+6内置模板）
